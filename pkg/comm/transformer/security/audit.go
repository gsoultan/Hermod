...
func init() {
	transformer.Register("audit", &AuditTransformer{})
}

type AuditTransformer struct{}

func (t *AuditTransformer) Transform(ctx context.Context, msg hermod.Message, config map[string]any) (hermod.Message, error) {
	if msg == nil {
		return nil, nil
	}
