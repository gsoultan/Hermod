...
func (e *Engine) UpdateNodeSample(nodeID string, data map[string]any) {
	...
	defer e.statusTracker.mu.Unlock()
	if e.statusTracker.nodeSamples == nil {
		e.statusTracker.nodeSamples = make(map[string]any)
	}
	...
	e.statusTracker.nodeSamples[nodeID] = sampleCopy
}
