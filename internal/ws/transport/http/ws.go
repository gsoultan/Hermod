...
func (h *WSHandler) RegisterWSRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /api/ws/out/{workflowID}", h.HandleWSOut)
	...
	mux.HandleFunc("GET /api/ws/debugger", h.HandleDebuggerWS)
}
...
func (h *WSHandler) HandleStatusWS(w http.ResponseWriter, r *http.Request) {
...
func (h *WSHandler) HandleDashboardWS(w http.ResponseWriter, r *http.Request) {
	conn, err := upgrader.Upgrade(w, r, nil)
	if err != nil {
		return
	}
...
func (h *WSHandler) HandleLiveMessagesWS(w http.ResponseWriter, r *http.Request) {
	conn, err := upgrader.Upgrade(w, r, nil)
	if err != nil {
		return
	}
...
func (h *WSHandler) HandleDebuggerWS(w http.ResponseWriter, r *http.Request) {
	conn, err := upgrader.Upgrade(w, r, nil)
	if err != nil {
		return
	}
